#!/bin/bash
# Script to set up K2 language installation hook
...
tee "$CONFIG_DIR/hooks/live/0050-install-k2-lang.hook.chroot" > /dev/null << 'EOF'
#!/bin/bash
...
tee "$CONFIG_DIR/package-lists/k2-dependencies.list.chroot" > /dev/null << 'EOF'
curl
wget
build-essential
EOF
